...
/* wave.c is ripped from microsoft's directx sdk example code. */
/* -------------------------------------------------------*/
...
int WaveLoadFile(TCHAR*pszFileName, /*(IN)*/ UINT *cbSize, // (OUT)
            WAVEFORMATEX **ppwfxInfo, /*(OUT)*/ BYTE **ppbData) // (OUT)
{
